  ...
  <section class="bg0 p-t-23 p-b-130">
    <div class="container">
      ...
      <x-product-card :image="'storage/' . $product->image" :name="$product->name" :price="$product->price"
        :detailUrl="route('product.detail', $product->id)" :label="now()->diffInDays($product->created_at) < 10 ? 'New' : ''" :categoryClass="$product->category->slug ?? 'uncategorized'" :description="$product->description"
